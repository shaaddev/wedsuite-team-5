    ...
    <div className="flex flex-col gap-4 rounded-xl border border-border/60 bg-card p-4 shadow-sm sm:flex-row sm:items-center">
      ...
      <div className="flex gap-3">
        <Select value={selectedCategory} onValueChange={onCategoryChange}>
          <SelectTrigger className="w-[180px] border-0 bg-transparent shadow-none text-sm" aria-label="Filter by category">
        ...
        <Select value={selectedSort} onValueChange={onSortChange}>
          <SelectTrigger className="w-[160px] border-0 bg-transparent shadow-none text-sm" aria-label="Sort vendors">
