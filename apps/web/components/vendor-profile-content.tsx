...
import { ArrowLeft, Check, Mail, MapPin, Phone, Star } from "lucide-react";
						...
						<Card className="rounded-2xl border-border/60 shadow-sm">
							...
							<CardContent className="flex flex-col gap-4">
								<p className="text-sm leading-relaxed text-muted-foreground">
									Reach out to {vendor.name} to discuss availability, pricing,
									and your vision.
								</p>
								...
								<Button
									variant="outline"
									className="w-full rounded-full text-xs uppercase tracking-widest font-medium"
								>
