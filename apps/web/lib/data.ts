...
export const vendors: Vendor[] = [
  {
    ...
    description: "Capturing timeless moments with a fine-art editorial approach. Specializing in natural light photography.",
    ...
    featured: true,
    services: ["Full Day Coverage", "Engagement Session", "Second Photographer", "Online Gallery", "Fine Art Prints", "Wedding Albums"],
  ...
  },
  {
    ...
    name: "Petal & Bloom",
    category: "Florist",
    description: "Romantic, garden-inspired floral designs crafted with seasonal blooms and lush foliage.",
    ...
    featured: true,
    services: ["Bridal Bouquet", "Ceremony Flowers", "Reception Centerpieces", "Archway Design", "Venue Consultation", "Setup & Teardown"],
  ...
  },
  {
    ...
    category: "Catering",
    description: "Farm-to-table wedding catering with seasonally inspired menus and impeccable service.",
    ...
    location: "Oakland, CA",
    featured: false,
    services: ["Menu Tasting", "Plated Dinner", "Buffet Style", "Food Stations", "Bar Service", "Late-Night Snacks"],
  ...
  },
  {
    ...
    category: "Venue",
    description: "A stunning hilltop estate offering panoramic views, elegant ballrooms, and manicured gardens.",
    ...
    location: "Sonoma, CA",
    featured: true,
    services: ["Ceremony Space", "Reception Hall", "Bridal Suite", "In-House Coordinator", "Rental Furnishings", "Parking & Valet"],
  ...
  },
  {
    ...
    name: "Rhythm & Events",
    category: "DJ & Music",
    description: "High-energy DJ and live music services that keep the dance floor alive all night long.",
    ...
    featured: false,
    services: ["DJ Services", "Live Band", "Sound System", "Lighting Design", "MC Services", "Custom Playlists"],
  ...
  },
  {
    ...
    description: "Full-service wedding planning and coordination for stress-free, beautifully designed celebrations.",
    ...
    location: "San Francisco, CA",
    featured: true,
    services: ["Full Planning", "Partial Planning", "Day-Of Coordination", "Vendor Management", "Design & Styling", "Budget Management"],
  ...
  },
  {
    ...
    description: "Artisanal wedding cakes and dessert tables featuring exquisite flavors and stunning designs.",
    ...
    featured: false,
    services: ["Custom Wedding Cake", "Dessert Table", "Macaron Tower", "Cupcake Display", "Cake Tasting", "Delivery & Setup"],
...
export const timelineItems: TimelineItem[] = [
  { id: "1", title: "Book venue", date: "2026-03-15", completed: true, category: "Venue" },
  { id: "2", title: "Hire wedding planner", date: "2026-03-20", completed: true, category: "Planning" },
  { id: "3", title: "Book photographer", date: "2026-04-01", completed: true, category: "Photography" },
  { id: "4", title: "Select catering menu", date: "2026-04-15", completed: false, category: "Catering" },
  { id: "5", title: "Book florist", date: "2026-05-01", completed: false, category: "Florist" },
  { id: "6", title: "Order wedding cake", date: "2026-05-15", completed: false, category: "Cake" },
  { id: "7", title: "Book DJ / band", date: "2026-06-01", completed: false, category: "Entertainment" },
  { id: "8", title: "Final venue walkthrough", date: "2026-07-15", completed: false, category: "Venue" },
  { id: "9", title: "Send invitations", date: "2026-06-15", completed: false, category: "Planning" },
  { id: "10", title: "Final dress fitting", date: "2026-08-01", completed: false, category: "Attire" },
  { id: "11", title: "Confirm all vendors", date: "2026-08-10", completed: false, category: "Planning" },
  { id: "12", title: "Wedding day", date: "2026-09-12", completed: false, category: "Celebration" },
]

export const budgetItems: BudgetItem[] = [
  { id: "1", category: "Venue", estimated: 18000, actual: 17500, paid: true, vendor: "Grandview Estate" },
  { id: "2", category: "Photography", estimated: 5000, actual: 5500, paid: true, vendor: "Golden Hour Studio" },
  { id: "3", category: "Catering", estimated: 10000, actual: 0, paid: false },
  { id: "4", category: "Florist", estimated: 3500, actual: 0, paid: false },
  { id: "5", category: "Cake & Desserts", estimated: 1500, actual: 0, paid: false },
  { id: "6", category: "DJ & Music", estimated: 2500, actual: 0, paid: false },
  { id: "7", category: "Wedding Planner", estimated: 6000, actual: 6000, paid: true, vendor: "Ever After Planning" },
  { id: "8", category: "Attire", estimated: 4000, actual: 3200, paid: true },
  { id: "9", category: "Invitations", estimated: 800, actual: 0, paid: false },
  { id: "10", category: "Decorations", estimated: 2000, actual: 0, paid: false },
]
